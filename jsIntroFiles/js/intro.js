...
document.getElementById('column1').innerHTML+="<p>I'm trying to test if i did it!</p>";
document.getElementById('column1').innerHTML+="<p>shit i did it!</p>";
...
document.getElementById('column2').style.color="#14C5E1F9";
document.getElementById('column2').style.backgroundColor="#ECF3C7F9";
document.getElementById('column2').style.fontSize="36pt";
...
//Send a message to column3 with what the opponent's health is (+= adding to it /// = putting in it)
...
//we need health to equal current health minus damage
